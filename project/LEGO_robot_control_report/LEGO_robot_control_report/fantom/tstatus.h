   ...
   class tStatus
   {
      public:
         ...
         */
         ...
         {
            ::strcpy_s( _fileName, "" );
            ::strncat_s( _fileName, status._fileName, kMaxFileNameLength - 1 );
         }
         ...
         */
         ...
         {
            ::strcpy_s( _fileName, "" );
            ::strncat_s( _fileName, reinterpret_cast<const char*>( fileName ), kMaxFileNameLength - 1 );
         }
         ...
         */
         inline void setCode( ViStatus code, const char* fileName, ViUInt32 lineNumber )
         {
            if(( isSuccess() && code != VI_SUCCESS ) || ( isNotFatal() && code < VI_SUCCESS ))
            {
               ...
               _lineNumber = lineNumber;
               ::strcpy_s( _fileName, "" );
               ::strncat_s( _fileName, fileName, kMaxFileNameLength - 1 );
            }
         }
